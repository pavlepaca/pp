...
public class ShopItemServiceTest {
    ...
    @Before
    public void setUp() {
        si = new ShopItem(1, "mleko", 10, 15);
        si = new ShopItem(2, "mleko", 5, 10);
        si = new ShopItem(3, "mleko", 50, 25);
        si = new ShopItem(4, "mleko", 20, 20);
        si = new ShopItem(5, "mleko", 30, 30);
    }
    ...
    public void testRemoveItem() {
        ...
        ShopItem s = new ShopItem(4, "mleko", 20, 20);
        ShopItemService instance = new ShopItemService();
        boolean expResult = true;
    ...
    public void testRemoveItem2() {
        System.out.println("removeItem");
        ShopItem s = new ShopItem(12, "mleko", 55, 10);;
        ShopItemService instance = new ShopItemService();
        boolean expResult = true;
        boolean result = instance.removeItem(s);
        assertEquals(expResult, result);
    ...
    public void testBuy() {
        ...
        ShopItem s = new ShopItem(2, "mleko", 5, 10);
        int amount = 5;
        ShopItemService instance = new ShopItemService();
    ...
    public void testStockUp() {
        ...
        ShopItem s = new ShopItem(1, "mleko", 10, 15);
        int amount = 50;
        ShopItemService instance = new ShopItemService();
    ...
    public void testStockUp2() {
        System.out.println("stockUp");
        ShopItem s = new ShopItem(5, "mleko", 30, 30);
        int amount = -5;
        ShopItemService instance = new ShopItemService();
        instance.stockUp(s, amount);
    }
